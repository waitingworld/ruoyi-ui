<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-search" size="mini" @click="queryDept">搜索</el-button>
  ...
  methods: {
    ...
    getList(tree, treeNode, resolve) {
      ...
      if (!tree) {
        ...
        listDept({ parentId: tree.deptId }).then(response => {
          let tmp = []
          response.data.forEach(item => {
            item.hasChildren = true
            item.children = []
